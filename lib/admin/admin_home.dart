...
const List<String> facultyOptions = [
  'কম্পিউটার সায়েন্স এন্ড ইঞ্জিনিয়ারিং',
  'এগ্রিকালচার',
  'বিজনেস এডমিনিস্ট্রেশন',
  'এনিমাল সায়েন্স এন্ড ভেটেরিনারি মেডিসিন',
  'ফিশারিজ',
  'এনভায়রনমেন্টাল সায়েন্স এন্ড ডিজাস্টার ম্যানেজমেন্ট',
  'নিউট্রেশন এন্ড ফুড সায়েন্স',
  'ল এন্ড ল্যান্ড এডমিনিস্ট্রেশন',
  'পোস্টগ্র্যাজুয়েট স্টাডিজ',
];

const List<String> deanOfficeDepartmentOptions = ['ডিন', 'ডিন অফিস'];

const List<String> teacherDesignationOptions = [
  'সেকশন অফিসার',
  'অফিসার ইনচার্জ',
  'সহযোগী অধ্যাপক',
  'অধ্যাপক',
...
const List<String> administrationDesignationOptions = [
  'বাজেট অফিসার',
  'ডেপুটি পরিবহন কর্মকর্তা',
  'পরিচালক(চুক্তি ভিত্তিক)',
  'হিসাবরক্‌্‌কন কর্মকর্তা',
  'পরিচালক (অ.দা.)',
  ...
  'অফিসার ইন-চার্জ',
  'সহকারী খামার তত্তাবধায়ক',
  'উপ-পরীক্ষা নিয়ন্ত্রক',
  'বিশেষ কর্মকর্তা পরিকল্পনা,উন্নয়ন ও ওয়ার্কস বিভাগ',
  'টেকনিক্যাল  অফিসার',
  'অফিস সহকারী',
  'তত্ত্বাবধায়ক প্রকৌশলী (সিভিল)',
  'ডেপুটি চীফ মেডিকেল অফিসার',
  'সহকারী প্রকৌশলী (সিভিল)',
  'সহকারী  রেজিস্ট্রার',
  'রেজিস্ট্রার (অ. দা. )',
  'অতিরিক্তপরিচালক(অ,দা.)',
  'প্রো-ভাইস চ্যান্সেলর',
  'সহকারী গ্রন্থাগারিক',
  'মেডিকেল অফিসার',
  'সহকারী  রেজিস্টার',
  'ছাত্র বিষয়ক উপদেস্টা',
  'রেজিস্টার (অ. দা. )',
  ...
  'চিফ মেডিকেল অফিসার (অ. দা.)',
  'নির্বাহী প্রকৌশলী (ইলেকট্রিক্যাল)',
];

const List<String> administrationFacultyOptions = [
...
const List<String> servicesDesignationOptions = [
  'ফিটার',
  'পরিচালক (অ.দা.)',
  'সেকশন অফিসার',
  'জরুরি প্রয়োজন',
  'সহকারী প্রক্টর',
  'সহকার নিরাপত্তা  কর্মকর্তা',
...
class TableModel {
  ...
  final List<String>
  primaryKeys; // primary key columns used for updates (supports composite keys)
  ...
  TableModel({
    ...
    this.description = '',
           ...
           primaryKeys ?? (primaryKey != null ? [primaryKey] : const ['id']);
...
final List<TableModel> databaseTables = [
  TableModel(
    ...
    plutoColumns: [
      ...
      PlutoColumn(
        title: 'Role',
        field: 'role',
        type: PlutoColumnType.select(profileRoleOptions),
      ),
    ],
  ),
  TableModel(
    ...
    description:
        'Dean faculties and departments (Composite PK: faculty + department)',
    plutoColumns: [
      PlutoColumn(
        title: 'Faculty',
        field: 'faculty',
  ...
  TableModel(
    ...
    plutoColumns: [
      ...
      PlutoColumn(
        title: 'Designation',
        field: 'designation',
        type: PlutoColumnType.select(deanOfficeDesignationOptions),
      ),
      PlutoColumn(
        title: 'Faculty',
        field: 'faculty',
        type: PlutoColumnType.select(facultyOptions),
      ),
      PlutoColumn(
        title: 'Priority',
        field: 'priority',
      ...
      PlutoColumn(
        title: 'Department',
        field: 'department',
        type: PlutoColumnType.select(deanOfficeDepartmentOptions),
      ),
    ],
  ),
  TableModel(
    ...
    primaryKeys: ['faculty', 'department'],
    description:
        'Departments under academic faculties (Composite PK: faculty + department)',
    plutoColumns: [
      PlutoColumn(
        title: 'Faculty',
        field: 'faculty',
  ...
  TableModel(
    ...
    plutoColumns: [
      ...
      PlutoColumn(
        title: 'Designation',
        field: 'designation',
        type: PlutoColumnType.select(teacherDesignationOptions),
      ),
      PlutoColumn(
        title: 'Faculty',
        field: 'faculty_name',
  ...
  TableModel(
    ...
    primaryKeys: ['faculty', 'department'],
    description:
        'Staff departments under academic faculties (Composite PK: faculty + department)',
    plutoColumns: [
      PlutoColumn(
        title: 'Faculty',
        field: 'faculty',
  ...
  TableModel(
    ...
    primaryKeys: ['faculty', 'department'],
    description:
        'Administration departments (Composite PK: faculty + department)',
    plutoColumns: [
      PlutoColumn(
        title: 'Faculty',
        field: 'faculty',
  ...
  TableModel(
    ...
    plutoColumns: [
      ...
      PlutoColumn(
        title: 'Designation',
        field: 'designation',
        type: PlutoColumnType.select(administrationDesignationOptions),
      ),
      PlutoColumn(
        title: 'Faculty',
        field: 'faculty_name',
        type: PlutoColumnType.select(administrationFacultyOptions),
      ),
      PlutoColumn(
        title: 'Priority',
        field: 'priority',
  ...
  TableModel(
    ...
    description:
        'Service departments (Composite PK: faculty_name + department)',
    plutoColumns: [
      PlutoColumn(
        title: 'Faculty',
        field: 'faculty_name',
  ...
  TableModel(
    ...
    plutoColumns: [
      ...
      PlutoColumn(
        title: 'Designation',
        field: 'designation',
        type: PlutoColumnType.select(servicesDesignationOptions),
      ),
      PlutoColumn(title: 'Email', field: 'email', type: PlutoColumnType.text()),
      PlutoColumn(
        title: 'Priority',
...
class _AdminTableViewState extends State<_AdminTableView> {
  ...
  Future<void> _fetchData() async {
    ...
    try {
      ...
      final data = await supabase.from(widget.table.name).select();
  ...
  Future<void> _updateCell(PlutoGridOnChangedEvent e) async {
    ...
    if (widget.table.hasCompositePrimaryKey) {
      if (widget.table.primaryKeys.contains(e.column.field)) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text(
                'Cannot edit primary key columns. Delete and re-add the row instead.',
              ),
            ),
          );
        }
      ...
      var query = supabase.from(widget.table.name).update({
        e.column.field: e.value,
      });
